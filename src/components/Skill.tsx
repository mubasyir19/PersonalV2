  ...
  return (
    <section className='px-3 lg:px-28 mt-12 text-white'>
      ...
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-4'>
        <div className='card py-8 text-center border-2 border-[#002352] rounded-md bg-gradient-to-tr from-blue-900 via-black to-black'>
      ...
      <p className='text-xl my-4'>Library / Framework</p>
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-4'>
        <div className='card py-8 text-center border-2 border-[#002352] rounded-md bg-gradient-to-tr from-blue-900 via-black to-black'>
      ...
      <p className='text-xl my-4'>Database</p>
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-4'>
        <div className='card w-full py-8 text-center border-2 border-[#002352] rounded-md bg-gradient-to-tr from-blue-900 via-black to-black'>
      ...
      <p className='text-xl my-4'>Software / Tools</p>
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-4'>
        <div className='card py-8 text-center border-2 border-[#002352] rounded-md bg-gradient-to-tr from-blue-900 via-black to-black'>
